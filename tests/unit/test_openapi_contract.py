...
def test_openapi_contract_contains_core_auth_endpoints() -> None:
    ...
    expected_methods = {
        ...
        "/api/v1/b2b/me": {"get"},
        "/api/v1/b2b/orgs": {"post"},
        "/api/v1/b2b/onboarding/applications": {"post"},
        "/api/v1/b2b/feeds": {"get", "post"},
        "/api/v1/b2b/campaigns": {"get", "post"},
        "/api/v1/b2b/analytics/overview": {"get"},
        ...
        "/api/v1/b2b/partners/leads/{lead_id}/status": {"get"},
        "/api/v1/applications/seller": {"post"},
        "/api/v1/applications/seller/status": {"get"},
        "/api/v1/seller/shop": {"get", "put"},
        "/api/v1/seller/products/": {"get", "post"},
        "/api/v1/seller/products/{product_id}": {"get", "put", "delete"},
        "/api/v1/seller/products/{product_id}/stock": {"patch"},
        "/api/v1/seller/products/{product_id}/inventory-log": {"get"},
        "/api/v1/seller/products/{product_id}/status-history": {"get"},
        "/api/v1/admin/sellers/applications": {"get"},
        "/api/v1/admin/sellers/applications/{application_id}": {"get"},
        "/api/v1/admin/sellers/applications/{application_id}/status": {"patch"},
        "/api/v1/admin/sellers/applications/bulk-status": {"post"},
        "/api/v1/admin/sellers/product-moderation/{product_id}/status-history": {"get"},
